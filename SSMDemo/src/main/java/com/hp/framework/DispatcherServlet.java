...
import com.hp.framework.bean.Handler;
import com.hp.framework.bean.Param;
import com.hp.framework.bean.View;
import com.hp.framework.helper.BeanHelper;
import com.hp.framework.helper.ConfigHelper;
import com.hp.framework.helper.ControllerHelper;
import com.hp.framework.helper.RequestHelper;
import com.hp.framework.util.ReflectionUtil;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        //初始化相关的helper类
        com.hp.framework.HelperLoader.init();
